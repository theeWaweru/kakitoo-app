  ...
  return (
    <div className="tos-body">
      <div className="terms-of-service">
        ...
        <p className="tos-text">
          &ldquo;Customer&ldquo; or &ldquo;You&ldquo; refers to you, the person
          who subscribes to, uses, or purchases any of our services or accesses
          our websites, as well as any other person who accesses any of the
          services to which you have subscribed. &ldquo;Kakitoo,
          &ldquo;we&ldquo;, &ldquo;us&ldquo;, &ldquo;our&ldquo;, and
          &ldquo;ours&ldquo; refer to Kakitoo Services Limited.
          <br />
          <br />
          The word &ldquo;includes&ldquo; implies that what follows is not
          necessarily exhaustive, and thus the examples provided are not the
          only things/situations included in the text&ldquo;s meaning or
          explanation.
        </p>
        ...
        <p className="tos-text">
          We collect and store information about you (&ldquo;Customer
          Information&ldquo;) based on the Kakitoo and third-party products and
          services you use and subscribe to. The Customer Information includes,
        ...
        <p className="tos-text">
          ...
          <br />
          <br />
          3.3.2 Charging you for the use of our or a third-products party&apos;s
          or services
          <br />
          <br />
        ...
        <p className="tos-text">
          ...
          &ldquo;cookies&ldquo;) on your computer. This allows us to recognise
          you on future visits. The information gathered is non-personal (for
          example, your computer&apos;s IP address, the date and time of your
          visit, which pages you browsed, and whether the pages were
